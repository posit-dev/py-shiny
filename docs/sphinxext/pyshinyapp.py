...
{{% extends "!layout.html" %}}
{{% block extrahead %}}
  <meta name="shinylive:serviceworker_dir" content="{SHINYLIVE_SW_DIR}">
  <script src="{join(SHINYLIVE_BASE_URL, 'shinylive/load-shinylive-sw.js')}" type="module"></script>
  <link rel="stylesheet" href="{join(SHINYLIVE_BASE_URL, 'shinylive/shinylive.css')}" type="text/css">
  <script src="{join(SHINYLIVE_BASE_URL, 'shinylive/run-python-blocks.js')}" type="module"></script>
{{% endblock %}}
"""
