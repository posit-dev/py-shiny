...
| Name | Description |
| --- | --- |
| [output_id](#shiny.render.renderer._renderer.RendererBase.output_id) | Output function name or ID (provided to `@output(id=)`). This value will contain any module prefix.  Set when the output is registered with the session. |
