...
class Session(ABC):
    ...
    @add_example(ex_dir="../api-examples/session_close")
    @abstractmethod
    ...
    @add_example(ex_dir="../api-examples/session_on_ended")
    @abstractmethod
    def on_ended(
        self,
    ...
    @add_example(ex_dir="../api-examples/session_send_custom_message")
    @abstractmethod
    ...
    @add_example(ex_dir="../api-examples/session_on_flush")
    @abstractmethod
    def on_flush(
        self,
        fn: Callable[[], None] | Callable[[], Awaitable[None]],
    ...
    @add_example(ex_dir="../api-examples/session_on_flushed")
    @abstractmethod
    def on_flushed(
        self,
        fn: Callable[[], None] | Callable[[], Awaitable[None]],
    ...
    @add_example(ex_dir="../api-examples/session_dynamic_route")
    @abstractmethod
