...
var BOX_CLASS = "shiny-chat-box";
var INPUT_CLASS = "shiny-chat-input";
var CHAT_MESSAGE_TAG = "shiny-chat-message";
var ShinyChatMessage = class extends s3 {
  constructor() {
    super(...arguments);
    this.role = "user";
    this.content = "...";
...
__decorateClass([
  n4()
], ShinyChatMessage.prototype, "role", 2);
__decorateClass([
  n4()
], ShinyChatMessage.prototype, "content", 2);
customElements.define(CHAT_MESSAGE_TAG, ShinyChatMessage);
var ShinyChatBoxInputBinding = class extends Shiny.InputBinding {
  constructor() {
    super();
  ...
  getValue(el) {
    ...
    const messages = [];
    messageContainers.forEach(function(x2) {
      const msg = {
        content: x2.getAttribute("content"),
        role: x2.getAttribute("role")
      };
      messages.push(msg);
    });
    return messages;
