(function() {
  ...
  function buildTabItem(nav, selected, id, index) {
    ...
    if (nav.classList.contains("nav-menu")) {
      ...
      navMenu.tabList.children.forEach(function(x) {
        x.classList.remove("nav-item");
        var link = x.querySelector(".nav-link");
        if (link) {
