	...
	*/
	...
	class Navs extends react.exports.Component {
	  constructor(props) {
	    ...
	    let selected = props.selected ? props.selected : this.firstNavValue(props.children); // Allow for false to "disable" the adding of active classes 
	...
	class NavsBar extends Navs {
	  render() {
	    ...
	    const navbarClass = `navbar navbar-default ${props.inverse ? 'navbar-inverse' : ''} ${props.position ? 'navbar-' + props.position : ''}`; // TODO: re-implement https://github.com/rstudio/bslib/blob/d77f5ce61003307e7a6dc3c211e7ac6ee6896582/R/navs-legacy.R#L225
	...
	function _isLightColor(color) {
	  ...
	  const L = 0.2126 * _getColorWeight(pcolor.red) + 0.7152 * _getColorWeight(pcolor.blue) + 0.0722 * _getColorWeight(pcolor.green); // The recommendation I found suggested 0.179 for the threshold,
	...
	function _parseColor(color) {
	  // Drop whitespace:
	  color = color.replace(/\s*,\s*/g, ",") // around commas
