	...
	*/
	...
	class NavsBar extends Navs {
	  render() {
	    ...
	    const navbarClass = `navbar navbar-default ${props.inverse ? 'navbar-inverse' : ''} ${props.position ? 'navbar-' + props.position : ''}`; // TODO: re-implement this...
	    // https://github.com/rstudio/bslib/blob/d77f5ce61003307e7a6dc3c211e7ac6ee6896582/R/navs-legacy.R#L225
