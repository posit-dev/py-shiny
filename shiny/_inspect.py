...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .graph-node, .graph-edge {{ transition: opacity 140ms ease, filter 140ms ease; }}
  ...
  <script>
    ...
    function renderGraph() {{
      ...
      svg.innerHTML = '<defs>' +
        ...
        '<marker id="arrow" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M 0 1.5 L 9 5 L 0 8.5 z" fill="#536579"/></marker>' +
        '<marker id="arrow-active" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M 0 1.5 L 9 5 L 0 8.5 z" fill="#63b3ff"/></marker>' +
        '<marker id="arrow-invalidate" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M 0 1.5 L 9 5 L 0 8.5 z" fill="#fb923c"/></marker>' +
        '</defs>';
      ...
      edges.forEach(e => {{
        ...
        if (p1 && p2) {{
          ...
          if (isEdgeActive) {{
            ...
            path.setAttribute('stroke', '#536579');
    ...
    function applyGraphFilters() {{
      ...
      document.querySelectorAll('.graph-edge').forEach(element => {{
        ...
        element.style.opacity = visible ? (element.getAttribute('data-active') === 'true' ? '1' : '0.58') : '0.04';
        element.setAttribute('stroke-width', element.getAttribute('data-active') === 'true' ? '3' : '1.35');
      }});
    }}
