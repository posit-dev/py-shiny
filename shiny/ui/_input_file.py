...
@doc(
    ...
    parameters={
        ...
        """,
        "button_label": "The label used on the button.",
        "placeholder": "The text to show on the input before a file has been uploaded.",
    },
    returns="A UI element.",
    note="""
    A unique file type specifier (i.e. a string provided to the **accept** parameter) can be
