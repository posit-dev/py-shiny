...
def test_validate_data_edit_mode(page: Page, local_app: ShinyAppProc) -> None:
    ...
    data_frame.expect_column_labels(['studyName', 'Sample Number', 'Species', 'Region', 'Island', 'Stage', 'Individual ID', 'Clutch Completion', 'Date Egg', 'Culmen Length (mm)', 'Culmen Depth (mm)', 'Flipper Length (mm)', 'Body Mass (g)', 'Sex', 'Delta 15 N (o/oo)', 'Delta 13 C (o/oo)', 'Comments'], edit=True)
    ...
    data_frame.expect_cell_validation_message(1, 5, "Penguin island should be one of 'Torgersen', 'Biscoe', 'Dream'")
