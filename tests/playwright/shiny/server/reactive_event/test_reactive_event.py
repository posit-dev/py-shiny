...
def test_output_image_kitchen(page: Page, local_app: ShinyAppProc) -> None:
    ...
    txt_immediate = controller.OutputCode(page, "txt_immediate")
    txt_render_delayed = controller.OutputCode(page, "txt_render_delayed")
    txt_reactive_delayed = controller.OutputCode(page, "txt_reactive_delayed")
