...
* Added a suite of built-in developer CLI tools: `shiny validate` statically checks apps for common reactivity errors and duplicate IDs; and `shiny simulate` runs an app's reactive graph in memory with supplied input values.
