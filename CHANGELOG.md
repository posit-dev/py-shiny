...
* `ui.sidebar(open=)` now accepts a new `ui.SidebarOpen` object, allowing you to independently control the initial state of the sidebar at desktop and mobile screen sizes. (#1129)
