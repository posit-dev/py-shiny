...
* Added `shiny simulate` CLI command and Python in-memory simulation API (`shiny.pytest.simulate`, `shiny.simulate.simulate`) to test reactive Shiny apps without a browser.
