...
- `input_selectize` now accepts [selectize options](https://selectize.dev/docs/api) and plugins
- `input_selectize` gains a `remove_button` argument which adds a button to remove a selected item.
