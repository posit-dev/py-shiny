...
* Added `shiny docs` CLI command to inspect signatures, types, parameters, and docstrings for functions, classes, Playwright controllers, and methods with AST parsing, JSON output mode, and shell tab completion.
