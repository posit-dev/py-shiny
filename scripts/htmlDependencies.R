...
ignore <- capture.output({
  pak::pkg_install(c("rstudio/bslib@a076e72e78562d7f006889da4118cd781c66c84c", "rstudio/shiny@main", "rstudio/htmltools@9338b7f3e2ed7b3fef8fd813904b9b05281344aa"))
})
