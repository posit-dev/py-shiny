...
from playground import InputDateRange
...
def expect_date_range(
    date: InputDateRange,
    start_value: typing.Union[datetime.date, str, typing.Literal["today"]] = "today",
    end_value: typing.Union[datetime.date, str, typing.Literal["today"]] = "today",
    *,
    label: str = "Date:",
    autoclose: bool = True,
