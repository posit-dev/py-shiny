...
def test_autoresize(page: Page, app: ShinyAppProc) -> None:
    ...
    left_sidebar.expect_toggle(True)
    left_sidebar.expect_toggle_expanded(True)
    left_sidebar.loc_toggle.click()
    left_sidebar.expect_toggle_expanded(False)
    ...
    right_sidebar.expect_toggle(True)
    right_sidebar.expect_toggle_expanded(True)
    right_sidebar.loc_toggle.click()
    right_sidebar.expect_toggle_expanded(False)
    ...
    closed_sidebar.expect_toggle(True)
    # why is it not working
    # closed_sidebar.expect_toggle_expanded(False)
    ...
    always_sidebar.expect_toggle(False)
